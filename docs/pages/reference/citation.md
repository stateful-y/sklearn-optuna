---
description: How to cite Sklearn-Optuna, in plain text and in BibTeX.
---
...
The version you used is the one `pip show sklearn_optuna` reports.

## Machine-readable metadata

The repository root carries a
[`CITATION.cff`](https://github.com/stateful-y/sklearn-optuna/blob/main/CITATION.cff)
...
No release of Sklearn-Optuna has been deposited with a DOI-issuing archive, so
